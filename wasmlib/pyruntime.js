...
var ASM_CONSTS = {
  65684: ($0, $1, $2) => { var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); ctx.beginPath(); ctx.arc($0, $1, $2, 0, 2 * Math.PI); ctx.stroke(); },  
 65839: ($0, $1, $2, $3) => { var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); ctx.beginPath(); ctx.rect($0, $1, $2, $3); ctx.stroke(); },  
...
/** @type {function(...*):?} */
var _circle = Module["_circle"] = createExportWrapper("circle");
/** @type {function(...*):?} */
var _rectangle = Module["_rectangle"] = createExportWrapper("rectangle");
/** @type {function(...*):?} */
var _clear = Module["_clear"] = createExportWrapper("clear");
/** @type {function(...*):?} */
var _color = Module["_color"] = createExportWrapper("color");
/** @type {function(...*):?} */
